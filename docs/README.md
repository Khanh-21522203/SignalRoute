...
| [plans/container_packaging.md](./plans/container_packaging.md) | Production fallback image contract, Docker build/run commands, Docker Compose dependency scaffold, mounted config behavior, and current container boundary. |
